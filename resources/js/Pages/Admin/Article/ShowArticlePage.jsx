                        ...
                        <div className="relative overflow-x-auto">
                            ...
                            <nav class="bg-gray-700 text-white p-2 mb-2 w-full rounded-md">
                                <ol class="list-reset flex">
                                    <li>
                                        <Link href={route("admin.dashboard")} class="text-blue-200 pl-3 text-primary transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600">
                                            All Articles
                                        </Link>
                                    </li>
                                    <li>
                            ...
                            <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                                <div className="flex justify-between border-b-2 border-neutral-100 px-6 py-3 dark:border-neutral-600 dark:text-neutral-50">
                                    <h1>{ article?.title }</h1>
                                    <button onClick={_=>deleteArticle(article.id)} type="button" className="p-0 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-1.5 py-0 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-blue-800">
                                        delete
                                    </button>
                                </div>
